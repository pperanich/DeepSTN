...
if XDST:
    ...
    print("loading data...")
    X_train,T_train,P_train,Y_train,X_test,T_test,P_test,Y_test,MM=prepare_data(all_data,poi,len_test,len_closeness,len_period,len_trend,T_closeness,T_period,T_trend)
